...
<form action="Register" method="post" onsubmit=" return val();" name="form" enctype="multipart/form-data">
<table>
...
<tr><td>Phone:</td><td><input type="text" name="phone" maxlength="10"></td><td id="phone" style="color:red;"></td></tr>
...
<tr><td>Image:</td><td><input type="file" name="photo" accept=".jpg"></td><td id="depart" style="color:red;"></td></tr>
<tr><td>Resume:</td><td><input type="file" name="resume" accept=".docx"></td><td id="depart" style="color:red;"></td></tr>
